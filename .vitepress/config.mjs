...
export default defineConfig({
  title: "Tổng Hợp Tài Liệu Lập Trình",
  description: "Tổng Hợp Tài Liệu Học Lập Trình Từ Cơ Bản Đến Nâng Cao - By klpod221",
  lang: 'vi-VN',
  base: '/lesson-plan/',
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: 'Copyright © 2024-present klpod221'
    },
