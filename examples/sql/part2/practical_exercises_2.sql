...
VALUES ('Laptop Dell XPS', 25000000),
...
VALUES (1, 1, 2), -- Nguyễn Văn A mua 2 Laptop Dell XPS
    ...
    (4, 5, 1);
-- Nguyễn Văn A mua 1 Màn hình LG
...
SELECT o.order_id, c.customer_name, p.product_name, oi.quantity, p.price, o.order_date
FROM
    orders o
