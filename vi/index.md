...
hero:
  ...
  actions:
    ...
    - theme: alt
      text: GitHub
      link: https://github.com/klpod221/lesson-plan
...
[Bắt đầu →](/vi/INTRODUCTION) | [Kỹ năng tự học →](/vi/SELF-LEARNING/Part1)
...
- [Học Java nâng cao →](/vi/JAVA/Part3)

##### Option B: PHP Backend

- PHP cơ bản, Laravel framework
- [Học PHP →](/vi/PHP/Part1)
...
- **[C/C++](/vi/C-CPP/Part1)** - Lập trình hệ thống, game, embedded systems
- **[Python](/vi/PYTHON/Part1)** - Data Science, Machine Learning, automation
- **[Rust](/vi/RUST/Part1)** - Lập trình hệ thống an toàn và hiệu năng cao

### Frontend Frameworks

Nâng cao kỹ năng frontend với các framework hiện đại:

- **[React.js](/vi/REACT/Part1)** - Thư viện UI phổ biến nhất từ Facebook
- **[Vue.js](/vi/VUE/Part1)** - Progressive framework dễ học, linh hoạt
